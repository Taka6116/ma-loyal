    ...
    <div className="w-full py-8 max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg border border-[#D0E3F0] focus:ring-2 focus:ring-[#0A2540]/30 focus:border-[#0A2540] outline-none transition-all text-sm resize-y min-h-[200px]"
              />
            </div>
      ...
      <div className="space-y-4">
        {prompts.length === 0 && !isEditorOpen ? (
          ...
          prompts.map(p => (
            <div key={p.id} className="bg-white border border-[#D0E3F0] rounded-xl p-5 hover:border-[#CBD5E1] transition-all group">
